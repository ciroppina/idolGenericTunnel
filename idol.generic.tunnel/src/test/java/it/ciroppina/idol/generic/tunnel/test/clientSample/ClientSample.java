...
public class ClientSample {
	...
	public static void main(String[] args) {
		...
		//test port1
		IdolOEMTunnel_Service service1 = actionsToSOAPPort1();

		//test port2
		actionsToSOAPPort2(service1);
        
		//build port ic
		IdolOEMTunnel ic = actionsToSOAPPortIc(service1);
	 ...
	 */
	public static void aQueryReturningListOfHits(IdolOEMTunnel ic) {
	 ...
	 * @param ic
	 */
	public static void aQueryWithPrintIndexTextFunction(IdolOEMTunnel ic) {
		HashMap<String, String> pList;
		String autnresponse;
	 ...
	 * @param ic
	 */
	public static void aCallToSpellCheckFunction(IdolOEMTunnel ic) {
		HashMap<String, String> pList;
		String autnresponse;
	 ...
	 * @param ic
	 */
	public static void anotherCallToSpellCheck(IdolOEMTunnel ic) {
		HashMap<String, String> pList;
	 ...
	 * @param ic
	 */
	public static void anotherGroupOfActionToSOAPPortIc(IdolOEMTunnel ic) {
		HashMap<String, String> pList;
		String autnresponse;
	 ...
	 */
	public static IdolOEMTunnel actionsToSOAPPortIc(
			IdolOEMTunnel_Service service1) {
		HashMap<String, String> pList;
		...
		IdolOEMTunnel ic = service1.getIdolOEMTunnelPort();
		/**
		 */
     ...
     */
	public static void actionsToSOAPPort2(IdolOEMTunnel_Service service1) {
		HashMap<String, String> pList;
        ...
        IdolOEMTunnel port2 = service1.getIdolOEMTunnelPort();
	 ...
	 */
	public static IdolOEMTunnel_Service actionsToSOAPPort1() {
        ...
        IdolOEMTunnel_Service service1 = new IdolOEMTunnel_Service();
        System.out.println("Create Web Service...");
        IdolOEMTunnel port1 = service1.getIdolOEMTunnelPort();
        System.out.println("Call Web Service Operation...");
