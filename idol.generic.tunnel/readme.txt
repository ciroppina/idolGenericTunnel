...
This is a Maven JEE7 JAX-WS project for tunneling http requests to an
OEM-Licensed HP IDOL Server
 ...
 The application will be running at the following URL:
  ...
  http://localhost:7070/idol.generic.tunnel
...
<settings
 ...
 Start JBoss AS. The application will be running at the following URL:
  ...
  http://localhost:8080/idol.generic.tunnel

 If you want to deploy to GlassFish (standalone), you can upload the
 target/idol.generic.tunnel.war archive using the web-based administration console.
